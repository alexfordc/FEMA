...
signals:
	...
	protected slots:
		void doSubmitOrder(const QString& orderLabel, const QString& speLabel, const QString& ins, const char& direction, const char& hedgeFlag, const char& offsetFlag, const int& volume, const double& orderPrice);
