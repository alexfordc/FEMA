...
void USTPMdSpi::OnRspUserLogin(CUstpFtdcRspUserLoginField *pRspUserLogin, CUstpFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
void USTPMdSpi::OnRtnDepthMarketData(CUstpFtdcDepthMarketDataField *pDepthMarketData)
{
	if (pDepthMarketData != NULL){
		emit onUSTPRtnDepthMarketData(QString(pDepthMarketData->InstrumentID), pDepthMarketData->PreSettlementPrice, pDepthMarketData->OpenPrice, 
			...
			pDepthMarketData->HighestPrice, pDepthMarketData->LowestPrice, pDepthMarketData->Volume);
